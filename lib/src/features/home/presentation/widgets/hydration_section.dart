  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Container(
            padding:  EdgeInsets.only(top: 13.78.h , left: 13.78.w , right: 13.78.w),
            child: Row(
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        '0%',
                          style: Theme.of(context).textTheme.displayLarge?.copyWith(color: AppColors.variantBlue)
                      ),
                      ...
                      Text(
                        'Log Now',
                        style: Theme.of(context).textTheme.bodySmall?.copyWith(color: AppColors.textVariantSecondary),
                      ),
